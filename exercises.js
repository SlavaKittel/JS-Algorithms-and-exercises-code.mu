...
const resultNumbers = arrNumbers[0] * arrNumbers[1] + arrNumbers[2] * arrNumbers[3];
...
var objWeek = { day1: "Mon", 2: "Tues", 3: "Wed", 4: "Thur", 5: "Fri", 6: "Sat", 7: "Sun" };
...
if (t == 0) {   // одиночное равно зарезервировано за присваиванием.
...
for (let i = 0; i < resultStr55v2.length; i++) {
  let newResultStr55v2 = resultStr55v2[i].toUpperCase()[0] + resultStr55v2[i].slice(1, Infinity); 
...
for (let i = 1; i < resultStr77.length; i++) {
  let mainResulrtStr77 = resultStr77[i].toUpperCase()[0] + resultStr77[i].slice(1, Infinity);
